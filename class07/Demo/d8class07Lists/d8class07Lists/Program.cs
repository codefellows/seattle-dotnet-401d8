using d8class07Lists.Classes;
using System;
using System.Collections.Generic;

namespace d8class07Lists
{
    class Program
    {
        // Enums ("Enumerations") - numeric constants that we can use as values for a user. 
        ...
        static void EnumExample()
        {
            ...
            Console.WriteLine($"conver to int {(int)dow}"); // output 6
            Console.WriteLine($" Conver to Day of Week { (Classes.DayOfWeek)6}"); // output Saturday
        }
